---
title: "【PCC】一个用python写的ｃ语言编译器"
date: 2019-01-01T00:00:00+08:00
updated: 2022-03-10T23:55:00+08:00
author: "兰州小红鸡"
tags:
  - "迁移自博客园"
...
origin:
  ...
  id: 15991910
  cnblogsDate: "2022-03-10 23:55"
  originalYear: 2019
---

## PCC——python实现编译器

大学的编译原理课设，实现源码到汇编代码的翻译，链接部分使用gcc的功能。目前支持数组，四则运算，赋值，判断，输出，循环语句等。

项目地址：[https://github.com/flymysql/Py-Compiler](https://github.com/flymysql/Py-Compiler)

## 源码说明

1.  lexer.py 词法分析器
2.  get\_predict\_table.py 生成预测分析表
3.  LR.py 非递归的语法分析器
